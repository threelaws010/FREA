...
the original script you shared, but without calling OpenAI's hosted API.

Changes from the previous version:
  - Recursively walks INPUT_DIR to find *.jpg files in all subfolders.
  - Keeps outputs next to each input image as before.
  - Preserves BATCH_LIMIT and other behaviors.
...
def find_jpgs_recursive(root_dir: str):
    ...
    Note: Only 'jpg' extension is searched, per request. Make lowercase comparison.
    """
