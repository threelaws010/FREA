...
try:
    ...
    logger.error("❌ Ollama not reachable!", exc_info=True)
...
<style>
    ...
    textarea[aria-label="Description"] {{ height: 200px; }}
    .element-container:has([aria-label="What coding issue can I help you resolve today?"]) {{ bottom: 45px; }}
</style>
"""
    ...
    if user_input:
        ...
        with st.chat_message("assistant"):
            ...
            try:
                ...
                st.error("Something went wrong with the model. Check server logs or Ollama status.")
                return
...
def display_chat():
    ...
    if st.session_state[f"generated"]:
        ...
        with st.expander("Not finding what you're looking for?"):
            st.write("Automatically generate a draft for an internal ticket to our support team.")
